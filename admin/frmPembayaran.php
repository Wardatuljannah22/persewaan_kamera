		...
		<content class="leftcolumn">
			<div class="card">
				...
				<?php
					...
					$Query_update="UPDATE tbl_penjualan SET total_penjualan=".$total_penjualanTr." WHERE kode_penjualan='$kode_transaksi'";
					...
					echo "<form action='frmNotaPenjualan.php' method='post'>
						<table>
							...
							<tr>
								<td></td>
								<td><button type='submit' name='submit' value='Bayar' style='width: 150px; height: 30px;'>Bayar</button></td>
							</tr>
						</table>
				 	</form>";
				?>
